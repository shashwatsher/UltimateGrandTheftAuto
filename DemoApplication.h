...
protected:
	...
	btVector3 m_cameraTargetPosition;//look at
        btVector3 m_cameraCanonPosition = btVector3(0.f,0.f,0.f);
        btCollisionShape* m_colShape;// colshape for building shaz code add
        //btboxShape* m_colShapeBox;// colshape for building shaz code add
...
public:
	...
	btVector3	getCameraTargetPosition()
	{
        ...
        btVector3	getCameraCanonPosition()
	{
		return m_cameraCanonPosition;
	...
	btVector3	getRayTo(int x,int y);
        btVector3	getRayToCanon(int x,int y);
